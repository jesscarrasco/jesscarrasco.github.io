...
function Texts(){
	...
	var title = "<fcWhite><fs39>7 sets Venn Diagram</f>"
	+"<br><fs20>128 color combinations from mixing 7 colors</f></f>";
	
	var text = "<fcWhite><fs18>Out of this <ehttp://www.informationisbeautiful.net/2012/7-way-venn/*seven sets Venn Diagram> (who's the author?) I created my own isomorphic version (meaning that I kept the same topology) trying to balance surface areas, so each piece has a similar visual importance.</f>"
